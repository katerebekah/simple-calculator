...
namespace Test
{
    ...
    public class ParserTest
    {
        ...
        public void turnStringArrayToIntArrayWithoutConstants()
        {
            ...
            CollectionAssert.AreEqual(p.ReplaceConstsandStringsWithIntValues(arr), new int[] { 3, 4 });
        }
        ...
        public void AddsKeyValuePairs()
        {
            ...
            Assert.AreEqual(Parser.Constants[arr[0]], 2);
        }
        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        ...
        public void GetsVariableValueFromDictionary()
        {
            ...
            CollectionAssert.AreEqual(new int[] { 10, 8 }, p2.ReplaceConstsandStringsWithIntValues(arr2));
        }
